...
const useCreateProfile = () => {
  const {control, handleSubmit /* watch */} = useForm<Profile>({
    resolver: zodResolver(PorfileSchema),
  });
  /* console.log('🚀 ~ useCreateProfile ~ watch:', watch()); */

  const handleFormError = (error: FieldErrors<Profile>) => {
      ...
      <View style={styles.form_container}>
        ...
        <View style={styles.form_header}>
          ...
          <Text style={styles.form_header_subtitle}>
            Completa la información para crear su perfil en la aplicación
          </Text>
        </View>
        ...
        <View style={styles.form_section_container}>
          <View style={styles.form_section_title_container}>
            ...
            <Text style={styles.form_section_title}>Información Personal</Text>
          </View>
            ...
            render={({field: {onChange, value}}) => (
              <View style={styles.pickerContainer}>
                <Picker
                  ...
                  <Picker.Item label={RH.AB_POSITIVE} value={RH.AB_POSITIVE} />
                  <Picker.Item label={RH.AB_NEGATIVE} value={RH.AB_NEGATIVE} />
                </Picker>
              </View>
            )}
          />
        ...
        <View style={styles.form_section_container}>
          ...
          <View>
            <Text style={styles.label}>EPS (Entidad Promotora de Salud) *</Text>
            <Controller
              control={control}
